        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex justify-between items-center mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">{{ __('Редактировать') }}</h2>
                    <a href="{{ route('admin.shifts.show', $shift) }}" class="text-gray-500 hover:text-gray-700">
